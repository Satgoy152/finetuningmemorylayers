...
def main():
    ...
    qwen_finetuned =  "/home/sagoyal/research/finetuningmemorylayers/qwen_memory_sft" #path needs to be changed

    base_tokenizer_id = "Qwen/Qwen2.5-0.5B-Instruct" 
    
    model_name = "hf"
    model_args = (
        f"pretrained={qwen_finetuned},"
        f"tokenizer={base_tokenizer_id},"
        "dtype=bfloat16,"
